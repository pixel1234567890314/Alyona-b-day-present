const BirthdayConfig = {
  ...
  letterText: "С днем ​​рождения, Алёночка. Надеюсь, этот маленький сюрприз станет для тебя теплым объятием сквозь экран. Ты делаешь обычные дни мягче, маленькие мгновения — ярче, а жизнь — чуточку волшебнее. Мне хотелось подарить тебе что-то особенное: неспешное, неслучайное, не просто очередное поздравление. Что-то, созданное только для тебя. Пусть сегодня ты почувствуешь, как сильно тебя любят и как бережно чествуют, пусть вспомнишь, что твое существование значит больше, чем могут выразить любые слова.",
